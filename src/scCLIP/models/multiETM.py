...
class MultiETM(BaseCellModel):
    ...
    def __init__(self,
        ...
        norm_method_gene: str = "library_size",
        norm_method_protein: str = "library_size",
        ...
        New args:
            n_trainable_proteins: number of trainable proteins
            norm_method_gene: the way to perform normalization on the genes
                library_size: divide the counts by the library size
                log_cpm: log of (counts per million + 1)
            norm_method_protein: the way to perform normalization on the proteins
                library_size: divide the counts by the library size
